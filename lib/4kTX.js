...
var rule = {
    ...
    // class_url: 'choice&tv&movie&variety&cartoon&child&doco',
 	class_name: '冬天4K电视剧&冬天4K电影&冬天4K综艺&冬天4K动漫&冬天4K少儿&冬天4K纪录片',
    ...
    lazy: $js.toString(() => {
        try {
            let api="http://101.201.171.207:9898/home/api?type=ys&uid=45770&key=bcdmnoqAEIJKO01245&url=" + input.split("?")[0];
            console.log(api);
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "冬天4k" : "冬天4K$$$";
