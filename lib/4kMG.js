var rule = {
    ...
    timeout: 5000,
    class_name: '冬天4K国产剧&冬天4K新电影&冬天4K国产综艺&冬天4K国产动漫&冬天4K国产纪录片&冬天4K国产教育&4k国产少儿',
    ...
    lazy: $js.toString(() => {
        try {
            let api = "http://101.201.171.207:8686/api/?key=nrP8DMvQsjgCzDHCfP&url=" + input.split("?")[0];
            console.log(api);
